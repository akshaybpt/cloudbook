        ...
        <>
            ...
            <div className="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog ">
                    <div className={`modal-content bg-${mode==='dark'?'dark':'light'}`}>
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Edit Note</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div className={`modal-body bg-${mode==='dark'?'dark':'light'}`}>
                            <form className="my-3">
                                <div className="mb-3">
                  ...
                  color: mode === 'light' ? 'black' : 'white'}} />
                        ...
                        <div className="modal-footer">
                            ...
                            <button disabled={note.etitle.length < 5 || note.edescription.length < 5} onClick={handleClick} type="button" className={`btn btn-${mode==='dark'? 'secondary': 'primary'}`}>Update Note</button>
                        </div>
                    </div>
                </div>
            </div>
